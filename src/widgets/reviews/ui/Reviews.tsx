    ...
    <section className="w-full px-4 py-16 md:py-24 bg-background overflow-hidden">
      <div className="container mx-auto max-w-7xl flex flex-col items-center gap-12 md:gap-16">
          ...
          <div className="flex lg:hidden justify-center gap-2 pt-10">
            {REVIEWS_DATA.map((_, index) => (
              <button
                ...
                className={cn(
                  "h-0.75 transition-all duration-300 rounded-full cursor-pointer",
                  current === index ? "w-8 bg-[#F16393]" : "w-4 bg-muted/60",
                )}
        ...
        <div className="pt-4 animate-in fade-in zoom-in-95 duration-700">
          <Button
            variant="outline"
            className="border-[#F16393] text-foreground hover:bg-[#F16393]/5 font-semibold rounded-xl px-10 py-6 h-auto text-base tracking-wide transition-all duration-300 cursor-pointer"
          >
